...
it('Object Equality', () => {
    ...
    expect(obj).eq(obj)
    expect(obj).to.be.equal(obj)               //comparando o objeto com ele mesmo
    expect(obj).to.be.deep.equal({a: 1, b: 2}) //comparativa com os elementos
    expect(obj).eql({a: 1, b: 2})
    expect(obj).include({a: 1})                //tem elemento a:1
    expect(obj).to.have.property('b')
    expect(obj).to.have.property('b', 2)       //encontra 'b' e o valor '2'
